(function (window) {
    ...
    platform.init = function (game) {
        ...
        platform.create(180,570,.70,.90);
        platform.create(460,520,.70,.90);
        platform.create(160,440,.70,.90);
        platform.create(460,360,.70,.90);
        platform.create(140,280,.70,.90);
        platform.create(80,0,.1,10);
